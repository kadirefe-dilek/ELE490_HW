...
plt.imsave(str(imageRootPath + fileSep + 'img_Cameraman_filteredH3.jpg'), img_Cameraman, cmap='gray')
plt.show()

plt.imshow(img_Cameraman_filteredH4, cmap='gray')
plt.axis('off')
plt.title('Filtered image: Cameraman filtered by h_4.')
plt.imsave(str(imageRootPath + fileSep + 'img_Cameraman_filteredH4.jpg'), img_Cameraman, cmap='gray')
plt.show()

plt.imshow(img_Cameraman_filteredH5, cmap='gray')
plt.axis('off')
plt.title('Filtered image: Cameraman filtered by h_5.')
plt.imsave(str(imageRootPath + fileSep + 'img_Cameraman_filteredH5.jpg'), img_Cameraman, cmap='gray')
plt.show()
...
plt.imsave(str(imageRootPath + fileSep + 'img_noisyCameraman_filteredH3.jpg'), img_noisyCameraman, cmap='gray')
plt.show()

plt.imshow(img_noisyCameraman_filteredH4, cmap='gray')
plt.axis('off')
plt.title('Filtered image: noisyCameraman filtered by h_4.')
plt.imsave(str(imageRootPath + fileSep + 'img_noisyCameraman_filteredH4.jpg'), img_noisyCameraman, cmap='gray')
plt.show()

plt.imshow(img_noisyCameraman_filteredH5, cmap='gray')
plt.axis('off')
plt.title('Filtered image: noisyCameraman filtered by h_5.')
plt.imsave(str(imageRootPath + fileSep + 'img_noisyCameraman_filteredH5.jpg'), img_noisyCameraman, cmap='gray')
plt.show()
